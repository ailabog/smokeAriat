...
public class HomePageRU extends BasePage implements List<HomePage> {
	
	private static final Logger logger = LoggerFactory.getLogger(HomePageRU.class);
   ...
   private boolean showMinicart;
	...
	protected HomePageRU(WebDriver driver) {
		super(driver);
	}
