...
public class HomePageQA extends BasePage implements List<HomePage> {
	
	private static final Logger logger = LoggerFactory.getLogger(HomePageQA.class);
	...
	protected HomePageQA(WebDriver driver) {
		super(driver);
	}
