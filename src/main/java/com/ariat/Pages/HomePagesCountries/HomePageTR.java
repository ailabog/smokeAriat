...
public class HomePageTR extends BasePage implements List<HomePage> {
	
	private static final Logger logger = LoggerFactory.getLogger(HomePageTR.class);
	...
	protected HomePageTR(WebDriver driver) {
		super(driver);
	}
