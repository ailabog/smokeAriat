...
public class HomePageCN extends BasePage implements List<HomePage> {
	
	private static final Logger logger = LoggerFactory.getLogger(HomePageCN.class);
	...
	protected HomePageCN(WebDriver driver) {
		super(driver);
	}
