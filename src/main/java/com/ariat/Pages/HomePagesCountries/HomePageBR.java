...
public class HomePageBR extends BasePage implements List<HomePage> {
	
	private static final Logger logger = LoggerFactory.getLogger(HomePageBR.class);
	...
	protected HomePageBR(WebDriver driver) {
		super(driver);
	}
