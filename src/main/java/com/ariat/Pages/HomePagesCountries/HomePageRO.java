...
public class HomePageRO extends BasePage implements List<HomePage> {
	
	private static final Logger logger = LoggerFactory.getLogger(HomePageRO.class);
	...
	protected HomePageRO(WebDriver driver) {
		super(driver);
	}
