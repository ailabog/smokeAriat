...
public class HomePageSE extends BasePage implements List<HomePage> {
	
	private static final Logger logger = LoggerFactory.getLogger(HomePageSE.class);
	...
	protected HomePageSE(WebDriver driver) {
		super(driver);
	}
