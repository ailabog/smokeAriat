...
public class HomePageNZ extends BasePage implements List<HomePage> {
	
	private static final Logger logger = LoggerFactory.getLogger(HomePageNZ.class);
	...
	protected HomePageNZ(WebDriver driver) {
		super(driver);
	}
