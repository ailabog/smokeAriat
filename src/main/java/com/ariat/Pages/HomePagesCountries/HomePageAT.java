...
public class HomePageAT extends BasePage implements List<HomePage> {
	
	private static final Logger logger = LoggerFactory.getLogger(HomePageAT.class);
	...
	protected HomePageAT(WebDriver driver) {
		super(driver);
	}
