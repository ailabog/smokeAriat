...
public class HomePageCA extends BasePage implements List<HomePage>{
	
	private static final Logger logger = LoggerFactory.getLogger(HomePageCA.class);
	...
	private By searchTextBox = By.id("desktop-search");
