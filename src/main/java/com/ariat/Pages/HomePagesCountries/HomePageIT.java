...
public class HomePageIT extends BasePage implements List<HomePage> {
	
	private static final Logger logger = LoggerFactory.getLogger(HomePageIT.class);
	...
	protected HomePageIT(WebDriver driver) {
		super(driver);
	}
