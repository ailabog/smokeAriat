...
public class HomePageFR extends BasePage implements List<HomePage> {
	
	private static final Logger logger = LoggerFactory.getLogger(HomePageFR.class);
   ...
   private By topsAndTshirtsText = By.xpath("//*[@id=\"main\"]/div/div[2]/div[2]/div[1]/span[1]");
	...
	public void assertProductDisplayed(String expectedText) {
		...
		assertEquals(text, expectedText, "Résultats pour:" + text);
	}
