package com.ariat.Tests.CountriesAccountTests.FI;
...
/**
 * Negative tests for Finland account
 * 
 * @author aila.bogasieru@ariat.com
 *
 */

public class ErrorMessagesAccountFITest extends BaseTest {
	...
	public void errorsAccountTest() {
		...
		homePageFI = (HomePageFI) homePage.chooseEULocation(euCountry.DK, euCountry.DK.getCurrencyISO());
