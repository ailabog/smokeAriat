...
/**
 * Tests for add & make default credit card Denmark
 * @author aila.bogasieru@ariat.com
 *
 */


public class Add_MakeDefaultCreditCardDKTest extends BaseTest{
	...
	@Test
	public void add_makeDefaultCreditCardDKTest() {
		String expirationDate = "MONTH/YEAR";
		logger.info("Starting add credit card & make it default Denmark test");
		...
		logger.info("Finishing add credit card & make it default Denmark test");
  } 
