...
public class MakeDefaultCreditCardDKTest extends BaseTest{
	...
	@Test
	public void makeDefaultCreditCardFromPaymentInfoDKTest() {
		logger.info("Starting make default credit card from Payment Info Denmark test");
		...
		logger.info("Finishing make default credit card from Payment info Denmark test");
