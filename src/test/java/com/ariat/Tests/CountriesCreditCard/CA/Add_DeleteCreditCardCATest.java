...
/**
 * Tests for add & deletet credit card Canada
 * @author aila.bogasieru@ariat.com
 *
 */


public class Add_DeleteCreditCardCATest extends BaseTest{
	...
	@Test
	public void add_deleteCreditCardCATest() {
		String expirationDate = "MONTH/YEAR";
		logger.info("Starting add credit card & delete it Canada test");
		...
		logger.info("Finishing add credit card & delete it Canada test");
  } 
