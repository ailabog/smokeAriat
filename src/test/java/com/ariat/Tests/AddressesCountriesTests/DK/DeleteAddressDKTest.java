package com.ariat.Tests.AddressesCountriesTests.DK;
...
public class DeleteAddressDKTest extends BaseTest {
	...
	public void deleteAddressDKTest() {
		...
		logger.info("Finishing deleting address Denmark test");
	}
