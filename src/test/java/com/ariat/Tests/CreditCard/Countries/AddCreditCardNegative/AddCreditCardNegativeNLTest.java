...
/**
 * Add credit card negative test Netherlands
 * @author aila.bogasieru@ariat.com
 *
 */


public class AddCreditCardNegativeNLTest extends BaseTest{
	...
	@Test
	public void addCreditCardNegativeNLTest() {
		logger.info("Starting add a credit card negative Netherlands test");
		...
		logger.info("Finishing add a credit card negative Netherlands test");
  } 
