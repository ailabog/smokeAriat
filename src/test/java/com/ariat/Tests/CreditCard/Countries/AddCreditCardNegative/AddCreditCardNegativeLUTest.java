...
/**
 * Add credit card negative test Luxembourg
 * @author aila.bogasieru@ariat.com
 *
 */


public class AddCreditCardNegativeLUTest extends BaseTest{
	...
	@Test
	public void addCreditCardNegativeLUTest() {
		logger.info("Starting add a credit card negative Luxembourg test");
		...
		logger.info("Finishing add a credit card negative Luxembourg test");
  } 
