...
public class DeleteCreditCardSETest extends BaseTest{
	...
	public void deleteCreditCardFromPaymentInfoNOTest() {
		logger.info("Starting delete credit card from Payment Info Sweden test");
		...
		logger.info("Finishing delete credit card from Payment info Sweden test");
