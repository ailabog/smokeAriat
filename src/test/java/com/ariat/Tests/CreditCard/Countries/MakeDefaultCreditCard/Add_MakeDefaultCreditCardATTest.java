...
/**
 * Tests for add & make default credit card Austria
 * @author aila.bogasieru@ariat.com
 *
 */


public class Add_MakeDefaultCreditCardATTest extends BaseTest{
	...
	@Test
	public void add_makeDefaultCreditCardATTest() {
		String expirationDate = "MONTH/YEAR";
		logger.info("Starting add credit card & make it default Germany test");
