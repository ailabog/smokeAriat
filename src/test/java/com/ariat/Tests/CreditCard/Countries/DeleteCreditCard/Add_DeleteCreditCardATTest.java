...
/**
 * Tests for add & deletet credit card Austria
 * @author aila.bogasieru@ariat.com
 *
 */


public class Add_DeleteCreditCardATTest extends BaseTest{
	...
	public void add_deleteCreditCardDETest() {
		...
		logger.info("Starting add credit card & delete it Austria test");
		...
		logger.info("Finishing add credit card & delete it Austria test");
  } 
