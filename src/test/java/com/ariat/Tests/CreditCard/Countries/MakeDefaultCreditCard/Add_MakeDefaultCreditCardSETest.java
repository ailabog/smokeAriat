...
/**
 * Tests for add & make default credit card Sweden
 * @author aila.bogasieru@ariat.com
 *
 */


public class Add_MakeDefaultCreditCardSETest extends BaseTest{
	...
	public void add_makeDefaultCreditCardLUTest() {
		...
		logger.info("Starting add credit card & make it default Sweden test");
		...
		logger.info("Finishing add credit card & make it default Sweden test");
  } 
