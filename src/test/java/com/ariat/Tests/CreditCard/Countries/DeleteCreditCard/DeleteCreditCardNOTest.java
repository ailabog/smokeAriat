...
public class DeleteCreditCardNOTest extends BaseTest{
	...
	@Test
	public void deleteCreditCardFromPaymentInfoNOTest() {
		logger.info("Starting delete credit card from Payment Info Norway test");
		...
		logger.info("Finishing delete credit card from Payment info Norway test");
