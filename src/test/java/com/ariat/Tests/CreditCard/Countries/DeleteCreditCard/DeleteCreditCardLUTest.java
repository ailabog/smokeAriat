...
public class DeleteCreditCardLUTest extends BaseTest{
	...
	public void deleteCreditCardFromPaymentInfoIETest() {
		logger.info("Starting delete credit card from Payment Info Luxembourg test");
		...
		logger.info("Finishing delete credit card from Payment info Luxembourg test");
