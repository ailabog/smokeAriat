...
public class DeleteCreditCardITTest extends BaseTest{
	...
	@Test
	public void deleteCreditCardFromPaymentInfoITTest() {
		logger.info("Starting delete credit card from Payment Info Italy test");
		...
		logger.info("Finishing delete credit card from Payment info Italy test");
