...
/**
 * Tests for add & deletet credit card Luxembourg
 * @author aila.bogasieru@ariat.com
 *
 */


public class Add_DeleteCreditCardLUTest extends BaseTest{
	...
	@Test
	public void add_deleteCreditCardLUTest() {
		String expirationDate = "MONTH/YEAR";
		logger.info("Starting add credit card & delete it Luxembourg test");
		...
		logger.info("Finishing add credit card & delete it Luxembourg test");
  } 
