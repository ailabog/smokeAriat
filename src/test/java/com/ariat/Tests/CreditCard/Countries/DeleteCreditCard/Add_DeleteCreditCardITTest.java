...
/**
 * Tests for add & delete credit card Italy
 * @author aila.bogasieru@ariat.com
 *
 */


public class Add_DeleteCreditCardITTest extends BaseTest{
	...
	@Test
	public void add_deleteCreditCardITTest() {
		String expirationDate = "MONTH/YEAR";
		logger.info("Starting add credit card & delete it Italy test");
		...
		logger.info("Finishing add credit card & delete it Italy test");
  } 
