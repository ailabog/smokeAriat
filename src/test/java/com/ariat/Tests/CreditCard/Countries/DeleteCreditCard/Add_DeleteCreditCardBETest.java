...
/**
 * Tests for add & deletet credit card Belgium
 * @author aila.bogasieru@ariat.com
 *
 */


public class Add_DeleteCreditCardBETest extends BaseTest{
	...
	@Test
	public void add_deleteCreditCardBETest() {
		String expirationDate = "MONTH/YEAR";
		logger.info("Starting add credit card & delete it Belgium test");
		...
		logger.info("Finishing add credit card & delete it Belgium test");
  } 
