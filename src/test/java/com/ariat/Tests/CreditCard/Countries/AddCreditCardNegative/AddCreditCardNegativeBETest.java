...
/**
 * Add credit card negative test Belgium
 * @author aila.bogasieru@ariat.com
 *
 */


public class AddCreditCardNegativeBETest extends BaseTest{
	...
	@Test
	public void addCreditCardNegativeBETest() {
		logger.info("Starting add a credit card negative Belgium test");
		homePage = new HomePage(new ChromeDriver());
		homePage.load(environment.DEVELOPMENT.getURL());
		homePageUK = (HomePageUK) homePage.chooseEULocation(euCountry.UK, euCountry.UK.getCurrencyISO());
		homePageBE = (HomePageBE) homePage.chooseEULocation(euCountry.BE, euCountry.BE.getCurrencyISO());signInPage = homePageBE.returnSignInPage();
		...
		logger.info("Finishing add a credit card negative Belgium test");
  } 
