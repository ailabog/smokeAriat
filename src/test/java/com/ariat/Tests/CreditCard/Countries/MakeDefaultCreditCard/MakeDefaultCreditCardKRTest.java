...
public class MakeDefaultCreditCardKRTest extends BaseTest {
	...
	public void makeDefaultCreditCardFromPaymentInfoJPTest() {
		logger.info("Starting make default credit card from Payment Info Korea test");
		...
		// "05/2016");
		logger.info("Finishing make default credit card from Payment info Korea test");
