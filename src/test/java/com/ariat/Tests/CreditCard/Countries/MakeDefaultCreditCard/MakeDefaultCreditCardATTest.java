...
/**
 * Tests for delete credit card Austria
 * 
 * @author aila.bogasieru@ariat.com
 *
 */

public class MakeDefaultCreditCardATTest extends BaseTest {
	...
	@Test
	public void makeDefaultCreditCardFromPaymentInfoDATTest() {
		logger.info("Starting make default credit card from Payment Info Austria test");
		...
		// "05/2016");
		logger.info("Finishing make default credit card from Payment info Austria test");
