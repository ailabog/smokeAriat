...
public class DeleteCreditCardTRTest extends BaseTest{
	...
	public void deleteCreditCardFromPaymentInfoJPTest() {
		logger.info("Starting delete credit card from Payment Info Turkey test");
		...
		logger.info("Finishing delete credit card from Payment info Turkey test");
