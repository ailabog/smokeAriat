...
/**
 * Add credit card negative test Italy
 * @author aila.bogasieru@ariat.com
 *
 */


public class AddCreditCardNegativeITTest extends BaseTest{
	...
	public void addCreditCardNegativeDKTest() {
		logger.info("Starting add a credit card negative Italy test");
		...
		logger.info("Finishing add a credit card negative Italy test");
  } 
