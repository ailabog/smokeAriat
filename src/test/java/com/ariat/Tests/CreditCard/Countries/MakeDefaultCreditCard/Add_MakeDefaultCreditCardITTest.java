...
/**
 * Tests for add & make default credit card Italy
 * @author aila.bogasieru@ariat.com
 *
 */


public class Add_MakeDefaultCreditCardITTest extends BaseTest{
	...
	@Test
	public void add_makeDefaultCreditCardITTest() {
		String expirationDate = "MONTH/YEAR";
		logger.info("Starting add credit card & make it default Italy test");
		...
		logger.info("Finishing add credit card & make it default Italy test");
  } 
