...
/**
 * Tests for add & make default credit card Taiwan
 * 
 * @author aila.bogasieru@ariat.com
 *
 */

public class Add_MakeDefaultCreditCardTWTest extends BaseTest {
	...
	public void add_makeDefaultCreditCardJPTest() {
		...
		logger.info("Starting add credit card & make it default Taiwan test");
		...
		logger.info("Finishing add credit card & make it default Taiwan test");
	}
