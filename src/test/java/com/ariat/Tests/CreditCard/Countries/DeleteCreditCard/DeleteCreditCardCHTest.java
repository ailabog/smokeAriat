...
public class DeleteCreditCardCHTest extends BaseTest{
	...
	@Test
	public void deleteCreditCardFromPaymentInfoCHTest() {
		logger.info("Starting delete credit card from Payment Info Cehia test");
		...
		logger.info("Finishing delete credit card from Payment info Cehia test");
