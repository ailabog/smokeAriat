...
/**
 * Tests for add & delete credit card Jersey
 * @author aila.bogasieru@ariat.com
 *
 */


public class Add_DeleteCreditCardJETest extends BaseTest{
	...
	@Test
	public void add_deleteCreditCardJETest() {
		String expirationDate = "MONTH/YEAR";
		logger.info("Starting add credit card & delete it Jersey test");
		...
		logger.info("Finishing add credit card & delete it Jersey test");
  } 
