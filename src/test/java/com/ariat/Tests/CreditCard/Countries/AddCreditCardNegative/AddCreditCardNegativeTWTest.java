...
/**
 * Add credit card negative test Taiwan
 * @author aila.bogasieru@ariat.com
 *
 */


public class AddCreditCardNegativeTWTest extends BaseTest{
	...
	@Test
	public void addCreditCardNegativeTWTest() {
		logger.info("Starting add a credit card negative Taiwan test");
		...
		logger.info("Finishing add a credit card negative Taiwan test");
  } 
