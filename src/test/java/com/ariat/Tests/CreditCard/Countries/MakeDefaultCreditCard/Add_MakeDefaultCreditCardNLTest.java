...
/**
 * Tests for add & make default credit card Netherlands
 * 
 * @author aila.bogasieru@ariat.com
 *
 */

public class Add_MakeDefaultCreditCardNLTest extends BaseTest {
	...
	public void add_makeDefaultCreditCardLUTest() {
		...
		logger.info("Starting add credit card & make it default Netherlands test");
		...
		logger.info("Finishing add credit card & make it default Netherlands test");
	}
