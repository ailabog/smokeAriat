...
/**
 * Add credit card negative test Cehia
 * @author aila.bogasieru@ariat.com
 *
 */


public class AddCreditCardNegativeCHTest extends BaseTest{
	...
	@Test
	public void addCreditCardNegativeCHTest() {
		logger.info("Starting add a credit card negative Cehia test");
		...
		logger.info("Finishing add a credit card negative Cehia test");
  } 
