...
/**
 * Tests for add & deletet credit card Norway
 * @author aila.bogasieru@ariat.com
 *
 */


public class Add_DeleteCreditCardNOTest extends BaseTest{
	...
	@Test
	public void add_deleteCreditCardNOTest() {
		String expirationDate = "MONTH/YEAR";
		logger.info("Starting add credit card & delete it Norway test");
		...
		logger.info("Finishing add credit card & delete it Norway test");
  } 
