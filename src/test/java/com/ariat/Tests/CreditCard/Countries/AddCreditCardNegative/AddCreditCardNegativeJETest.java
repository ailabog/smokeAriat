...
/**
 * Add credit card negative test Jersey
 * @author aila.bogasieru@ariat.com
 *
 */


public class AddCreditCardNegativeJETest extends BaseTest{
	...
	public void addCreditCardNegativeJPTest() {
		logger.info("Starting add a credit card negative Jersey test");
		...
		logger.info("Finishing add a credit card negative Jersey test");
  } 
