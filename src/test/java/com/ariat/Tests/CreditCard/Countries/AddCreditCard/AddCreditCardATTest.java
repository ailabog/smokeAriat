...
/**
 * Tests for Add Credit card Austria
 * @author aila.bogasieru@ariat.com
 *
 */


public class AddCreditCardATTest extends BaseTest{
	...
	@Test(priority = 0)
	public void addCreditCardATTest() {
		String expirationDate = "MONTH/YEAR";
		logger.info("Starting add a credit card Austria test");
		...
		logger.info("Finishing add a credit card Austria test");
  } 
	...
	public void addCreditCardFromPaymentInfoATTest() {
		...
		logger.info("Finishing add credit card from Payment info Austria test");
