...
/**
 * Tests for Negative Add Credit card Norway
 * 
 * @author aila.bogasieru@ariat.com
 *
 */

public class NegativeAddCreditCardNOTest extends BaseTest {
	...
	@Test(priority = 0)
	public void negativeAddCreditCardNOTest() {
		String expirationDate = "MONTH/YEAR";
		logger.info("Starting add negative credit card NO test");
		...
		logger.info("Finishing add negative credit card NO test");
  } 

	@Test(priority = 1)
	public void negativeAddCreditCardNOTestWildCard() {
		String expirationDate = "MONTH/YEAR";
		logger.info("Starting add negative credit card NO test");
		homePage = new HomePage(new ChromeDriver());
		homePage.load(environment.DEVELOPMENT.getURL());
	...
	@Test(priority = 2)
	public void negativeAddCreditCardNOTestMissingValues() {
		String expirationDate = "MONTH/YEAR";
		logger.info("Starting add negative credit card NO test");
		homePage = new HomePage(new ChromeDriver());
		homePage.load(environment.DEVELOPMENT.getURL());
	...
	@Test(priority = 3)
	public void negativeAddCreditCardNOTestExpirationDate() {
		String expirationDate = "MONTH1/YEAR1";
		logger.info("Starting add a credit card NO test");
		homePage = new HomePage(new ChromeDriver());
		homePage.load(environment.DEVELOPMENT.getURL());
		homePageUK = (HomePageUK) homePage.chooseEULocation(euCountry.UK, euCountry.UK.getCurrencyISO());
		homePageNO = (HomePageNO) homePage.chooseEULocation(euCountry.NO, euCountry.NO.getCurrencyISO());
		...
		paymentInfoPage = addACreditCardPage.returnPaymentInformationPage();
		paymentInfoPage.checkCreditCard(CARD_OWNER, typeCard.VISA.getName(), expirationDate);
		logger.info("Finishing add a credit card NO test");
	}
