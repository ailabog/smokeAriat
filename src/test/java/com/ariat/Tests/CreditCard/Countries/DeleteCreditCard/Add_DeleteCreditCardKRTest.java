...
/**
 * Tests for add & deletet credit card Korea
 * @author aila.bogasieru@ariat.com
 *
 */


public class Add_DeleteCreditCardKRTest extends BaseTest{
	...
	@Test
	public void add_deleteCreditCardKRTest() {
		String expirationDate = "MONTH/YEAR";
		logger.info("Starting add credit card & delete it Korea test");
		...
		logger.info("Finishing add credit card & delete it Korea test");
  } 
