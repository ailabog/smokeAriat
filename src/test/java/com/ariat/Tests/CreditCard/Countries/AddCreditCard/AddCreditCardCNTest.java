...
/**
 * Tests for Add Credit card China
 * @author aila.bogasieru@ariat.com
 *
 */


public class AddCreditCardCNTest extends BaseTest{
	...
	@Test(priority = 0)
	public void addCreditCardCNTest() {
		String expirationDate = "MONTH/YEAR";
		logger.info("Starting add a credit card China test");
		...
		logger.info("Finishing add a credit card China test");
  } 
	
	@Test(priority = 1)
	public void addCreditCardFromPaymentInfoJPTest() {
		logger.info("Starting add credit card from Payment Info China test");
		homePage = new HomePage(new ChromeDriver());
		homePage.load(environment.DEVELOPMENT.getURL());
		homePageCN = (HomePageCN) homePage.chooseGlobalLocation(country.CN, country.CN.getCurrencyISO());
		signInPage = homePageCN.returnSignInPage();
		...
		logger.info("Finishing add credit card from Payment info China test");
