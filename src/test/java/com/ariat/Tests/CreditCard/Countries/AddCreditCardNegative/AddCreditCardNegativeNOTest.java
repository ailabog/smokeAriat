...
/**
 * Add credit card negative test Norway
 * @author aila.bogasieru@ariat.com
 *
 */


public class AddCreditCardNegativeNOTest extends BaseTest{
	...
	@Test
	public void addCreditCardNegativeNOTest() {
		logger.info("Starting add a credit card negative Norway test");
		...
		logger.info("Finishing add a credit card negative Norway test");
  } 
