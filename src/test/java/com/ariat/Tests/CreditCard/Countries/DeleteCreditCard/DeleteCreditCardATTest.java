...
public class DeleteCreditCardATTest extends BaseTest{
	...
	@Test
	public void deleteCreditCardFromPaymentInfoATTest() {
		logger.info("Starting delete credit card from Payment Info Austria test");
		...
		logger.info("Finishing delete credit card from Payment info Austria test");
