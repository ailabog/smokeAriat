...
/**
 * Tests for add & make default credit card China
 * @author aila.bogasieru@ariat.com
 *
 */


public class Add_MakeDefaultCreditCardCNTest extends BaseTest{
	...
	@Test
	public void add_makeDefaultCreditCardCNTest() {
		String expirationDate = "MONTH/YEAR";
		logger.info("Starting add credit card & make it default China test");
		...
		logger.info("Finishing add credit card & make it default China test");
  } 
