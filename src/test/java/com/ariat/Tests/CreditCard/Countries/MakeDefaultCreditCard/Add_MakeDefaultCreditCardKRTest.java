...
/**
 * Tests for add & make default credit card Korea
 * 
 * @author aila.bogasieru@ariat.com
 *
 */

public class Add_MakeDefaultCreditCardKRTest extends BaseTest {
	...
	@Test
	public void add_makeDefaultCreditCardKRTest() {
		String expirationDate = "MONTH/YEAR";
		logger.info("Starting add credit card & make it default Korea test");
		...
		logger.info("Finishing add credit card & make it default Korea test");
	}
