...
public class ProductAddToCartWomenCategoryCHTest extends BaseTest {
	...
	public void productPageWomenCategoryAddToCartTest() {
		...
		womenCategoryPage = homePageCH.returnWomenCategoryPage();
	...
	public void productPageWomenCategoryAddToCartNoFreeGiftTest() {
		...
		womenFootwearCasualShoesCategoryPage = womenFootwearPage.returnWomenFootwearCasualShoesCategoryPageDE();
