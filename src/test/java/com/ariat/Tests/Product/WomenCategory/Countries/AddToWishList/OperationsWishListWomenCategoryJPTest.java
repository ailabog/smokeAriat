...
public class OperationsWishListWomenCategoryJPTest extends BaseTest {
	...
	public void productPageWomenCategoryAddToWishListShareToAFriendTest() {
		...
		womenClothingTopsAndTshirtsPage = homePageJP.returnWomenClothingTopsAndTshirtsPage();
