...
public class OperationsWishListWomenCategoryRUTest extends BaseTest {
	...
	public void productPageWomenCategoryAddToWishListShareToAFriendTest() {
		...
		womenClothingTopsAndTshirtsPage = homePageRU.returnWomenClothingTopsAndTshirtsPage();
