...
/**
 * Make default test Cehia
 * 
 * @author aila.bogasieru@ariat.com
 *
 */

public class MakeDefaultAddressCHTest extends BaseTest {
	...
	public void makeDefaultAddressFRTest() {
		logger.info("Starting make default address Cehia test");
		...
		logger.info("Finishing make default address Cehia test");
	}
