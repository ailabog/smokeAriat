...
public class AddAddressNOTest extends BaseTest {
	...
	@Test
	public void addAddressNOTest() {
		logger.info("Starting add address Norway test");
		...
		logger.info("Finishing add address Norway test");
	}
