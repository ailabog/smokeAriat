...
/**
 * Adds a new address and checks the address was created for Italy
 * 
 * @author aila.bogasieru@ariat.com
 *
 */

public class AddAddressITTest extends BaseTest {
	...
	@Test
	public void addAddressITTest() {
		logger.info("Starting add address Italy test");
		...
		logger.info("Finishing add address Italy test");
	}
