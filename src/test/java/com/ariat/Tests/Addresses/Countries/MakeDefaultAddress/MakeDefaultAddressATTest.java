...
/**
 * Make default test Austria
 * 
 * @author aila.bogasieru@ariat.com
 *
 */

public class MakeDefaultAddressATTest extends BaseTest {
	...
	public void makeDefaultAddressFRTest() {
		logger.info("Starting make default address Austria test");
		...
		addressesPage.makeDefaultAddressCreated("BWMSV");
		addressesPage.assertMakeDefaultDE("STANDARD | BWMSV");
		logger.info("Finishing make default address Austria test");
	}
