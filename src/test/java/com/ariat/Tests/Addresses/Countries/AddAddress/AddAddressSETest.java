...
/**
 * Adds a new address and checks the address was created for Sweden
 * 
 * @author aila.bogasieru@ariat.com
 *
 */

public class AddAddressSETest extends BaseTest {
	...
	public void addAddressSEest() {
		...
		addAddressPage.selectCountry("Sweden");
