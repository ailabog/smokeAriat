...
/**
 * Make default test Norway
 * 
 * @author aila.bogasieru@ariat.com
 *
 */

public class MakeDefaultAddressNOTest extends BaseTest {
	...
	public void makeDefaultAddressNOTest() {
		logger.info("Starting make default address Norway test");
		...
		logger.info("Finishing make default address Norway test");
	}
