...
/**
 * Make default test Italy
 * 
 * @author aila.bogasieru@ariat.com
 *
 */

public class MakeDefaultAddressITTest extends BaseTest {
	...
	public void makeDefaultAddressIETest() {
		logger.info("Starting make default address Italy test");
		...
		logger.info("Finishing make default address Italy test");
	}
