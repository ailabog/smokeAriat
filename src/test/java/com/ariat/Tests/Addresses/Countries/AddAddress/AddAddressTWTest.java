...
/**
 * Adds a new address and checks the address was created for Taiwan
 * 
 * @author aila.bogasieru@ariat.com
 *
 */

public class AddAddressTWTest extends BaseTest {
	...
	@Test
	public void addAddressTWTest() {
		logger.info("Starting add address Taiwan test");
		...
		addAddressPage.selectCountry("Taiwan");
		...
		logger.info("Finishing add address Taiwan test");
	}
