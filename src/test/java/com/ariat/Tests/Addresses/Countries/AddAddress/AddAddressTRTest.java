...
/**
 * Adds a new address and checks the address was created for Turkey
 * 
 * @author aila.bogasieru@ariat.com
 *
 */

public class AddAddressTRTest extends BaseTest {
	...
	@Test
	public void addAddressTRTest() {
		logger.info("Starting add address Turkey test");
		...
		addAddressPage.selectCountry("Turkey");
		...
		logger.info("Finishing add address Turkey test");
	}
