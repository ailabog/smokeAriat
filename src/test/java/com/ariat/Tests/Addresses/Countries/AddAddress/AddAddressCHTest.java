...
/**
 * Adds a new address and checks the address was created for Cehia
 * 
 * @author aila.bogasieru@ariat.com
 *
 */

public class AddAddressCHTest extends BaseTest {
	...
	@Test
	public void addAddressCHTest() {
		logger.info("Starting add address Cehia test");
		...
		addAddressPage.selectCountry("Tschechische Republik");
		...
		logger.info("Finishing add address Cehia test");
	}
