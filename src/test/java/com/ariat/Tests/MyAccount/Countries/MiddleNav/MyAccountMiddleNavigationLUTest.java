...
public class MyAccountMiddleNavigationLUTest extends BaseTest {
	...
	@Test(priority = 0)
	public void myAccountAccessPersonalInfoLUTest() {
	...
	@Test(priority = 1)
	public void myAccountAccessEmailPrefLUTest() {
	...
	@Test(priority = 2)
	public void myAccountAccessAddressesLUTest() {
	...
	@Test(priority = 3)
	public void myAccountAccessPaymentInfoLUTest() {
	...
	@Test(priority = 4)
	public void myAccountAccessOrdersLUTest() {
	...
	@Test(priority = 5)
	public void myAccountAccessWishListLUTest() {
