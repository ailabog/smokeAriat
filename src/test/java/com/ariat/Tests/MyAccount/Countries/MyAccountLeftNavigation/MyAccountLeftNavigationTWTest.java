...
/**
 * Include tests for My account left navigation Taiwan
 * 
 * @author aila.bogasieru@ariat.com
 *
 */

public class MyAccountLeftNavigationTWTest extends BaseTest {
	...
	public void myAccountAccessPersonalInfoJPTest() {
		logger.info("Starting personal info Taiwan test...");
		...
		logger.info("Finishing personal info Taiwan test...");
	}

	@Test(priority = 1)
	public void myAccountAccessEmailPrefJPTest() {
		logger.info("Starting email preferences Taiwan test...");
		homePage = new HomePage(new ChromeDriver());
		homePage.load(environment.DEVELOPMENT.getURL());
		homePageTW = (HomePageTW) homePage.chooseGlobalLocation(country.TW, country.TW.getCurrencyISO());
		signInPage = homePageTW.returnSignInPage();
		...
		myAccountPage.myAccountClick();
		myAccountPage.logoutMiddle();
		logger.info("Finishing email preferences Taiwan test...");
	}

	@Test(priority = 2)
	public void myAccountAccessAddressesJPTest() {
		logger.info("Starting addresses Taiwan test...");
		homePage = new HomePage(new ChromeDriver());
		homePage.load(environment.DEVELOPMENT.getURL());
		homePageTW = (HomePageTW) homePage.chooseGlobalLocation(country.TW, country.TW.getCurrencyISO());
		signInPage = homePageTW.returnSignInPage();
		...
		myAccountPage.myAccountClick();
		myAccountPage.logoutMiddle();
		logger.info("Finishing addresses Taiwan test...");
	}

	@Test(priority = 3)
	public void myAccountAccessPaymentInfoJPTest() {
		logger.info("Starting payment info Taiwan test...");
		homePage = new HomePage(new ChromeDriver());
		homePage.load(environment.DEVELOPMENT.getURL());
		homePageTW = (HomePageTW) homePage.chooseGlobalLocation(country.TW, country.TW.getCurrencyISO());
		signInPage = homePageTW.returnSignInPage();
		...
		myAccountPage.myAccountClick();
		myAccountPage.logoutMiddle();
		logger.info("Finishing payment info Taiwan test...");
	}

	@Test(priority = 4)
	public void myAccountAccessOrdersJPTest() {
		logger.info("Starting orders Taiwan test...");
		homePage = new HomePage(new ChromeDriver());
		homePage.load(environment.DEVELOPMENT.getURL());
		homePageTW = (HomePageTW) homePage.chooseGlobalLocation(country.TW, country.TW.getCurrencyISO());
		signInPage = homePageTW.returnSignInPage();
		...
		myAccountPage.myAccountClick();
		myAccountPage.logoutMiddle();
		logger.info("Finishing orders Taiwan test...");
	}

	@Test(priority = 5)
	public void myAccountAccessWishListJPTest() {
		logger.info("Starting wish list Taiwan test...");
		homePage = new HomePage(new ChromeDriver());
		homePage.load(environment.DEVELOPMENT.getURL());
		homePageTW = (HomePageTW) homePage.chooseGlobalLocation(country.TW, country.TW.getCurrencyISO());
		signInPage = homePageTW.returnSignInPage();
		...
		myAccountPage.myAccountClick();
		myAccountPage.logoutMiddle();
		logger.info("Finishing wish list Taiwan test...");
	} 
