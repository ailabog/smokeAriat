...
/**
 * Test pages redirection from Women Category to all its sub-categories tree Russia test
 * structure
 * 
...
public class WomenCategoriesAndSubcategoriesTopNavRUTest extends BaseTest {
