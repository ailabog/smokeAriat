...
/**
 * Test pages redirection from Men Category to all its sub-categories tree Canada test
 * structure
 * 
...
public class MenCategoriesAndSubcategoriesTopNavCATest extends BaseTest {
