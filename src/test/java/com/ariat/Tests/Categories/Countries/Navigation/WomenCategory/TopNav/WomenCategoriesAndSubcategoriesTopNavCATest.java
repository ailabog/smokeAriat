...
/**
 * Test pages redirection from Women Category to all its sub-categories tree Canada test
 * structure
 * 
...
public class WomenCategoriesAndSubcategoriesTopNavCATest extends BaseTest {
