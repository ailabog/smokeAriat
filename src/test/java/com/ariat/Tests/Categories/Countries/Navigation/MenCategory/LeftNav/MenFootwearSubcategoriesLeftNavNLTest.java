...
/**
 * Left navigation for Men category Nertherlands test
 * 
 * @author aila.bogasieru@ariat.com
 *
 */

public class MenFootwearSubcategoriesLeftNavNLTest extends BaseTest {
	...
	public void leftNavigationMenFootwearRidingSubcategories() {
		...
		menCategoryPage = homePageNL.returnMenCategoryPage();
