...
/**
 * Left navigation for Men category Norway test
 * 
 * @author aila.bogasieru@ariat.com
 *
 */

public class MenFootwearSubcategoriesLeftNavNOTest extends BaseTest {
	...
	public void leftNavigationMenFootwearRidingSubcategories() {
		...
		menCategoryPage = homePageNO.returnMenCategoryPage();
