...
/**
 * Test pages redirection from Women Category to all its sub-categories tree Ireland test
 * structure
 * 
...
public class WomenCategoriesAndSubcategoriesTopNavIETest extends BaseTest {
