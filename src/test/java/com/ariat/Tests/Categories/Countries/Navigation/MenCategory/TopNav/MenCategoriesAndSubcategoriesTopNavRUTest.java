...
/**
 * Test pages redirection from Men Category to all its sub-categories tree Russia test
 * structure
 * 
...
public class MenCategoriesAndSubcategoriesTopNavRUTest extends BaseTest {
