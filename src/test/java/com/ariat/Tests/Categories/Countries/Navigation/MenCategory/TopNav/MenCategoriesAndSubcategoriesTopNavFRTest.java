...
/**
 * Test pages redirection from Men Category to all its sub-categories tree France test
 * structure
 * 
...
public class MenCategoriesAndSubcategoriesTopNavFRTest extends BaseTest {
