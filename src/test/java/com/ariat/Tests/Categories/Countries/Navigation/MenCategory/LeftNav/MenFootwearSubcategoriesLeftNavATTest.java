...
/**
 * Left navigation for Men category Austria test
 * 
 * @author aila.bogasieru@ariat.com
 *
 */

public class MenFootwearSubcategoriesLeftNavATTest extends BaseTest {
	...
	public void leftNavigationMenFootwearRidingSubcategories() {
		...
		menCategoryPage = homePageAT.returnMenCategoryPage();
