...
/**
 * Test pages redirection from Women Category to all its sub-categories tree Finland test
 * structure
 * 
...
public class WomenCategoriesAndSubcategoriesTopNavFITest extends BaseTest {
