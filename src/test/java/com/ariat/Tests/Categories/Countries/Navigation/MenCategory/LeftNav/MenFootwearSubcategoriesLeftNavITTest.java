...
/**
 * Left navigation for Men category Italy test
 * 
 * @author aila.bogasieru@ariat.com
 *
 */

public class MenFootwearSubcategoriesLeftNavITTest extends BaseTest {
	...
	public void leftNavigationMenFootwearRidingSubcategories() {
		...
		menCategoryPage = homePageIT.returnMenCategoryPage();
