...
/**
 * Left navigation for Men category Sweden test
 * 
 * @author aila.bogasieru@ariat.com
 *
 */

public class MenFootwearSubcategoriesLeftNavSETest extends BaseTest {
	...
	public void leftNavigationMenFootwearRidingSubcategories() {
		...
		menCategoryPage = homePageSE.returnMenCategoryPage();
