...
/**
 * Test pages redirection from Women Category to all its sub-categories tree Denmark test
 * structure
 * 
...
public class WomenCategoriesAndSubcategoriesTopNavDKTest extends BaseTest {
