 ...
 * all the methods such as: create account, login, check order status for Qatar
 * 
 * @author aila.bogasieru@ariat.com
 *
 */

public class CreateAccountQATest extends BaseTest {
	...
	public void createAccountTest() {
		...
		signInPage = homePageQA.returnSignInPage();
