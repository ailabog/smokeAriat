 ...
 * all the methods such as: create account, login, check order status for Turkey
 * 
 * @author aila.bogasieru@ariat.com
 *
 */

public class CreateAccountTRTest extends BaseTest {
...
@Test(priority = 1)
	...
	public void checkInvalidOrderTest() {
		...
		homePage = new HomePage(new ChromeDriver());
		homePage.load(environment.DEVELOPMENT.getURL());
		homePageTR = (HomePageTR) homePage.chooseGlobalLocation(country.JP, country.JP.getCurrencyISO());
		signInPage = homePageTR.returnSignInPage();
